  ...
  render(){
    return (
      <div className="home fade-in">
        <div className="hero" style={document.documentElement.classList.contains('webp') ? { backgroundImage: "url('" + data.homebgs[Math.floor(Math.random() * data.homebgs.length)].webp + "')"} : {backgroundImage: "url('" + data.homebgs[Math.floor(Math.random() * data.homebgs.length)].fallback + "')"}}>
        </div>
